...
async def transcribe_endpoint(file: UploadFile = File(...), model=whisper.load_model("tiny.en"), debate_topic: str = "", side: str = ""):
    try:
        ...
        azure_output = pf_feedback(debate_topic, transcription, side)
